...
libs <- c("R.rsp", "devtools", "sf", "survival", "ggplot2", "gridExtra",
  "DiagrammeR", "car", "ggpubr", "spdep", "RColorBrewer", "spatstat", "sp",
  "latticeExtra", "gridExtra", "gstat", "raster", "ggfortify", "joineR",
  "BayesSurvival", "icenReg", "nloptr", "boot")
